...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_59 = NL + "int deletedCount_";
  protected final String TEXT_60 = "=0;" + NL + "String tableName_";
  protected final String TEXT_61 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_62 = " = null;";
  protected final String TEXT_63 = NL + "\tdbschema_";
  protected final String TEXT_64 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_65 = "\");" + NL + "\t";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "\t";
  protected final String TEXT_68 = NL + "if(dbschema_";
  protected final String TEXT_69 = " == null || dbschema_";
  protected final String TEXT_70 = ".trim().length() == 0) {" + NL + "\ttableName_";
  protected final String TEXT_71 = ";" + NL + "} else {" + NL + "\ttableName_";
  protected final String TEXT_72 = " = dbschema_";
  protected final String TEXT_73 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_74 = ";" + NL + "}";
  protected final String TEXT_75 = NL + "     String tmpTableName_";
  protected final String TEXT_76 = " = \"tmp_";
  protected final String TEXT_77 = "_\" + pid + Thread.currentThread().getId(); //tableName not end. will add pid + Thread.currentThread().getId() when create a temp table for update.";
  protected final String TEXT_78 = NL + "String bulkSQL_";
  protected final String TEXT_79 = " = \"COPY \\\"\" + ";
  protected final String TEXT_80 = "tmpTableName_";
  protected final String TEXT_81 = "tableName_";
  protected final String TEXT_82 = " ";
  protected final String TEXT_83 = NL + "+ \"\\\"";
  protected final String TEXT_84 = "FROM \" + " + NL + "\t\t";
  protected final String TEXT_85 = " \"'\" + ";
  protected final String TEXT_86 = ".replaceAll(\"\\\"\",\"\") +\"'\" ";
  protected final String TEXT_87 = " \"STDIN\" ";
  protected final String TEXT_88 = NL + "\t\t+ \" WITH \";";
  protected final String TEXT_89 = NL + "    bulkSQL_";
  protected final String TEXT_90 = " += \"BINARY ";
  protected final String TEXT_91 = "\";";
  protected final String TEXT_92 = NL + "    Character field_separator_";
  protected final String TEXT_93 = " = (";
  protected final String TEXT_94 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_95 = " += \"";
  protected final String TEXT_96 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_97 = " + \"' \";" + NL + "\t";
  protected final String TEXT_98 = NL + "\t\tbulkSQL_";
  protected final String TEXT_99 = " += \"NULL AS '\" + ";
  protected final String TEXT_100 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t";
  protected final String TEXT_101 = NL + "        Character text_enclosure_";
  protected final String TEXT_102 = ").charAt(0);";
  protected final String TEXT_103 = NL + "            \tbulkSQL_";
  protected final String TEXT_104 = " += \"CSV ";
  protected final String TEXT_105 = " QUOTE AS '\" + ";
  protected final String TEXT_106 = "+ \"' \";" + NL + "\t\t";
  protected final String TEXT_107 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_108 = " QUOTE AS \" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_109 = ".toString())?\"E\":\"\") + \"'\" +(\"'\".equals(text_enclosure_";
  protected final String TEXT_110 = ")?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_111 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\tbulkSQL_";
  protected final String TEXT_113 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_114 = NL + "\t        \tbulkSQL_";
  protected final String TEXT_115 = " += \"ESCAPE AS \" + (\"'\".equals(";
  protected final String TEXT_116 = ")?\"E\":\"\")  + \"'\" +(\"'\".equals(";
  protected final String TEXT_117 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_118 = " + \"' \"; ";
  protected final String TEXT_119 = NL + NL + "       \t\t\tbulkSQL_";
  protected final String TEXT_120 = " QUOTE AS '\" +  ";
  protected final String TEXT_121 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_122 = " QUOTE AS '\" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_123 = ".toString())?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_124 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_125 = " += \"ESCAPE AS '\"+ ";
  protected final String TEXT_126 = " += \"ESCAPE AS '\"+ (\"'\".equals(";
  protected final String TEXT_127 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_128 = "        " + NL + "        bulkSQL_";
  ...
  protected final String TEXT_135 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_136 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\t";
  protected final String TEXT_137 = NL + "\t            String url_";
  protected final String TEXT_138 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_139 = "+\":\"+";
  protected final String TEXT_140 = "+\";DatabaseName=\"+";
  protected final String TEXT_141 = ";" + NL + "\t            ";
  protected final String TEXT_142 = " + \"?\" + ";
  protected final String TEXT_143 = NL + "\t\t";
  protected final String TEXT_144 = " = \"org.postgresql.Driver\";" + NL + "\t\t\t";
  protected final String TEXT_145 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_146 = " + \":\" + ";
  protected final String TEXT_147 = " + \"/\" + ";
  protected final String TEXT_148 = NL + "\t\t" + NL + "\t\tString dbUser_";
  protected final String TEXT_149 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_150 = ").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_156 = NL + "\t   \t" + NL + "\t\tString dbPwd_";
  protected final String TEXT_157 = " = decryptedPassword_";
  ...
  protected final String TEXT_164 = " - Droping table ";
  protected final String TEXT_165 = "\" + tableName_";
  protected final String TEXT_166 = " + \"";
  protected final String TEXT_167 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_169 = ".execute(\"";
  protected final String TEXT_170 = "\");" + NL + "\t\t\t";
  protected final String TEXT_171 = " - Drop table ";
  protected final String TEXT_172 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_173 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_174 = " - Creating table ";
  protected final String TEXT_175 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_176 = NL + "\t\t\t\t";
  protected final String TEXT_177 = NL + "routines.system.Dynamic dynamicColumn = (Dynamic)globalMap.get(\"";
  protected final String TEXT_178 = "\" + \"_DYNAMIC\");" + NL + "boolean guessSchemaFromFile = (Boolean)globalMap.get(\"";
  protected final String TEXT_179 = "\" + \"_DYNAMIC_GSFF\");" + NL + "" + NL + "//We should do nothing when tSetDynamicSchema doesn't guess schema from file" + NL + "//If guessSchemaFromFile = true we can modify columns metadata" + NL + "if (guessSchemaFromFile){" + NL + "\t";
  protected final String TEXT_180 = NL + "\t\tfor (DynamicMetadata column_";
  protected final String TEXT_181 = " : dynamicColumn.metadatas){" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\tif (column_";
  protected final String TEXT_183 = ".getType().equals(\"id_Double\")){" + NL + "\t\t\t\tcolumn_";
  protected final String TEXT_184 = ".setLength(";
  protected final String TEXT_185 = ");" + NL + "\t\t\t} else if (column_";
  protected final String TEXT_186 = ".getType().equals(\"id_String\")){" + NL + "\t\t\t\tcolumn_";
  protected final String TEXT_187 = ".getType().equals(\"id_Boolean\")){" + NL + "\t\t\t\tcolumn_";
  protected final String TEXT_188 = ".setType(\"id_String\");" + NL + "\t\t\t\tcolumn_";
  protected final String TEXT_189 = ".setLength(5);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_190 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_191 = NL + "}" + NL + "String columnsPart = DynamicUtils.getCreateTableSQL(dynamicColumn, \"";
  protected final String TEXT_192 = "\");" + NL + "" + NL + "//Escape table name" + NL + "String queryForExec = \"\";";
  protected final String TEXT_193 = NL + "\tqueryForExec = \"CREATE TABLE \" + \"[\" + tableName_";
  protected final String TEXT_194 = " + \"] (\" + columnsPart + \")\";";
  protected final String TEXT_195 = NL + "\tqueryForExec = \"CREATE TABLE \" + tableName_";
  protected final String TEXT_196 = " + \" (\" + columnsPart + \")\";";
  protected final String TEXT_197 = NL + "\tlog.debug(\"";
  protected final String TEXT_198 = " - Creating table with query: \" + queryForExec);";
  protected final String TEXT_199 = NL + "stmtCreate_";
  protected final String TEXT_200 = ".execute(queryForExec);" + NL + "\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_202 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_203 = " - Create table ";
  protected final String TEXT_204 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_205 = ".close();" + NL + "\t\t";
  protected final String TEXT_206 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_207 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_208 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_209 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_210 = " = tableNameForSearch_";
  protected final String TEXT_211 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  ...
  protected final String TEXT_228 = ".equalsIgnoreCase(";
  protected final String TEXT_229 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_230 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_234 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_242 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_243 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_244 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_245 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_246 = " = stmtSchema_";
  protected final String TEXT_247 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_248 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_249 = " = rsSchema_";
  protected final String TEXT_250 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_251 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_252 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_258 = " ==null || dbschema_";
  protected final String TEXT_259 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_260 = "(schema_";
  protected final String TEXT_261 = NL + "            \tString tableForSearch_";
  protected final String TEXT_262 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_263 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_264 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_265 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_266 = " =  tableForSearch_";
  protected final String TEXT_267 = ".substring(1,tableForSearch_";
  protected final String TEXT_268 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_269 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_276 = ".getTables(null, dbschema_";
  protected final String TEXT_277 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_278 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_279 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_280 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  protected final String TEXT_281 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_282 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "                rsTable_";
  protected final String TEXT_283 = ".close();";
  protected final String TEXT_284 = NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_285 = ".getMetaData();";
  protected final String TEXT_286 = NL + "                    java.sql.ResultSet rsTable_";
  protected final String TEXT_287 = ".getTables(";
  protected final String TEXT_288 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_289 = ".getTables(conn_";
  protected final String TEXT_290 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_291 = NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_297 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_298 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_300 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_303 = ".execute(queryForExec);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_330 = " - Trancating table ";
  protected final String TEXT_331 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_332 = "\");" + NL + "   \t    \t";
  protected final String TEXT_333 = " - Truncate table ";
  ...
  protected final String TEXT_337 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_338 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_339 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_340 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_341 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_342 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_343 = "\t";
  protected final String TEXT_344 = NL + "        int keyCount_";
  protected final String TEXT_345 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_346 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_347 = " = tableName_";
  protected final String TEXT_348 = ";" + NL + "        tableName_";
  protected final String TEXT_349 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_350 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_351 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_352 = " - Creating temp table ";
  protected final String TEXT_353 = ".\" );" + NL + "\t\t";
  protected final String TEXT_354 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_355 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_356 = " - Create temp table ";
  protected final String TEXT_357 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_358 = NL + "        ";
  protected final String TEXT_359 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_360 = " =conn_";
  protected final String TEXT_361 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_362 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_363 = ".close();" + NL + "   \t\t";
  protected final String TEXT_364 = "        " + NL + "        " + NL + "\t\t";
  protected final String TEXT_365 = NL + "\t\t\tjava.sql.Statement stmtBulk_";
  protected final String TEXT_366 = ".createStatement();" + NL + "\t\t\t//stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t\t\tstmtBulk_";
  protected final String TEXT_367 = ".execute(bulkSQL_";
  protected final String TEXT_368 = ");" + NL + "\t\t\tstmtBulk_";
  protected final String TEXT_369 = ".close(); " + NL + "\t\t";
  protected final String TEXT_370 = NL + "\t\t\ttry (java.io.FileReader fileReader = new java.io.FileReader(";
  protected final String TEXT_371 = ")){" + NL + "\t\t\t\torg.postgresql.copy.CopyManager copyManager = new org.postgresql.copy.CopyManager((org.postgresql.core.BaseConnection) conn_";
  protected final String TEXT_372 = ");" + NL + "\t\t\t\tcopyManager.copyIn(bulkSQL_";
  protected final String TEXT_373 = ", fileReader );" + NL + "\t\t\t} \t\t\t" + NL + "\t\t";
  protected final String TEXT_374 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_375 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_376 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_377 = " - Bulk inserting data into ";
  protected final String TEXT_378 = " - Bulk insert data into ";
  protected final String TEXT_379 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_380 = NL + "        tableName_";
  protected final String TEXT_381 = " = tmpTableName_";
  protected final String TEXT_382 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_383 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_384 = " - Updating ";
  protected final String TEXT_385 = " from ";
  protected final String TEXT_386 = "\"+tmpTableName_";
  protected final String TEXT_387 = "+\"";
  protected final String TEXT_388 = ".\");" + NL + "\t\t";
  protected final String TEXT_389 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_390 = "\");" + NL + "\t\t";
  protected final String TEXT_391 = ".close();" + NL + "        tableName_";
  protected final String TEXT_392 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_393 = " - Droping temp table ";
  protected final String TEXT_394 = NL + "        stmtTmpDrop_";
  protected final String TEXT_395 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_396 = " - Drop temp table ";
  protected final String TEXT_397 = "+ \"";
  protected final String TEXT_398 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_399 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_400 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_401 = NL + "    " + NL + "\t";
  protected final String TEXT_402 = NL + "\t\tjava.sql.Statement stmtBulk_";
  protected final String TEXT_403 = ".createStatement();" + NL + "\t\t//stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t\tstmtBulk_";
  protected final String TEXT_404 = ");" + NL + "\t\tstmtBulk_";
  protected final String TEXT_405 = ".close(); " + NL + "\t";
  protected final String TEXT_406 = NL + "\t\ttry (java.io.FileReader fileReader = new java.io.FileReader(";
  protected final String TEXT_407 = ")){" + NL + "\t\t\torg.postgresql.copy.CopyManager copyManager = new org.postgresql.copy.CopyManager((org.postgresql.core.BaseConnection) conn_";
  protected final String TEXT_408 = ");" + NL + "\t\t\tcopyManager.copyIn(bulkSQL_";
  protected final String TEXT_409 = ", fileReader );" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_410 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_411 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_412 = " - Inserting records in table ";
  protected final String TEXT_413 = ".\");" + NL + "\t";
  protected final String TEXT_414 = NL + "\t" + NL + "\t";
  protected final String TEXT_415 = NL + "\t\tlog.info(\"";
  protected final String TEXT_416 = " - Insert records in table ";
  protected final String TEXT_417 = " has finished.\");" + NL + "\t";
...
String driverIfGreenplum = ElementParameterParser.getValue(node,"__DRIVER_IF_GREENPLUM__");
...
boolean isLocalFile = "true".equalsIgnoreCase(ElementParameterParser.getValue(node,"__LOCAL_FILE__"));
...
String userName = ElementParameterParser.getValue(node, "__USER__");
    ...
    if(driverIfGreenplum.equals("GREENPLUM")){
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(dynamicComponentName);
    ...
    stringBuffer.append(floatLengthForDynamic);
    stringBuffer.append(TEXT_185);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_186);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_184);
    stringBuffer.append(varcharLengthForDynamic);
    stringBuffer.append(TEXT_185);
    stringBuffer.append(cid);
    ...
    stringBuffer.append(dbmsId==null?"":dbmsId.toLowerCase());
