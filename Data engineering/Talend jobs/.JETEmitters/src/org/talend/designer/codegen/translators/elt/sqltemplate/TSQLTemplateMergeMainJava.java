...
public class TSQLTemplateMergeMainJava {

  protected static String nl;
  public static synchronized TSQLTemplateMergeMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateMergeMainJava result = new TSQLTemplateMergeMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "_NB_LINE\",stmt_";
  protected final String TEXT_5 = ".getUpdateCount());" + NL + "globalMap.put(\"";
  protected final String TEXT_6 = "_NB_LINE_MERGED\",stmt_";
  protected final String TEXT_7 = ".getUpdateCount());" + NL + "" + NL + "stmt_";
  protected final String TEXT_8 = ".close();" + NL;
    ...
    public String generateSQLPatternCode(INode node) {
		...
		boolean useBatch=!(dbType.equalsIgnoreCase("HIVE")||dbType.equalsIgnoreCase("DELTALAKE"));
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_2);
    stringBuffer.append(TEXT_2);
    stringBuffer.append(declareVariables.toString());
    stringBuffer.append(TEXT_2);
    stringBuffer.append(TEXT_2);
