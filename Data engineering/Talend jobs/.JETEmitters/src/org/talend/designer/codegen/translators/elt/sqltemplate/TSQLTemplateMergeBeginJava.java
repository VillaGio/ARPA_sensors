...
public class TSQLTemplateMergeBeginJava {
  ...
  protected final String TEXT_14 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_15 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_16 = " = dbMetaData_";
  protected final String TEXT_17 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_18 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_19 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_20 = " = rsTable_";
  protected final String TEXT_21 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_22 = ".equalsIgnoreCase(";
  protected final String TEXT_23 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_24 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_25 = NL + "                if(!whetherExist_";
  protected final String TEXT_26 = ") {" + NL + "                    stmt_";
  protected final String TEXT_27 = "\");            " + NL + "                }                ";
  protected final String TEXT_28 = NL + "                if(whetherExist_";
  protected final String TEXT_29 = "\");" + NL + "                }" + NL + "                stmt_";
