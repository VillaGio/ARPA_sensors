...
public class TPostgresqlRowBeginJava
{
  ...
  protected final String TEXT_103 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_104 = " = null;" + NL + "\tString query_";
  protected final String TEXT_105 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_106 = " = false;";
  ...
  protected final String TEXT_111 = ".prepareStatement(";
  protected final String TEXT_112 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_113 = "\", pstmt_";
  protected final String TEXT_114 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_115 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
