...
public class TPostgresqlOutputBulkMainJava
{
  ...
  protected final String TEXT_22 = NL + "               \tString[] row_";
  ...
  protected final String TEXT_32 = NL + "                            \trow_";
  ...
  protected final String TEXT_38 = "] = java.nio.charset.Charset.forName(";
  protected final String TEXT_39 = ").decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_40 = ")).toString();";
  protected final String TEXT_41 = NL + "  \t\t\t\t\t\t}";
  protected final String TEXT_42 = NL + "\t\t\t\t\tfor (int i_";
  protected final String TEXT_43 = " = 0; i_";
  protected final String TEXT_44 = " < row_";
  protected final String TEXT_45 = ".length; i_";
  protected final String TEXT_46 = "++) {" + NL + "\t               \t\tString temp_";
  protected final String TEXT_47 = " = row_";
  protected final String TEXT_48 = "[i_";
  protected final String TEXT_49 = "];" + NL + "\t               \t\t" + NL + "\t    \t\t        if(i_";
  protected final String TEXT_50 = " != 0) {" + NL + "    \t    \t       \t\tout";
  protected final String TEXT_51 = ".write(OUT_DELIM_";
  protected final String TEXT_52 = ".toString());" + NL + "        \t        \t}" + NL + "        \t        \tif(!";
  protected final String TEXT_53 = ".equals(temp_";
  protected final String TEXT_54 = ")){" + NL + "        \t        \t  temp_";
  protected final String TEXT_55 = " = temp_";
  protected final String TEXT_56 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\");" + NL + "        \t        \t}" + NL + "\t\t           \t\tout";
  protected final String TEXT_57 = ".write(temp_";
  protected final String TEXT_58 = ");" + NL + "    \t\t        }";
  protected final String TEXT_59 = "++) {" + NL + "\t\t\t\t\t\tif(i_";
  protected final String TEXT_60 = " != 0) {" + NL + "                        \tout";
  protected final String TEXT_61 = ".toString());" + NL + "                        }" + NL + "                \t\tString temp_";
  protected final String TEXT_62 = "];" + NL + "                        if(!";
  protected final String TEXT_63 = ")) {" + NL + "                            if (escape_mode_";
  protected final String TEXT_64 = " == 0 ) { // double quotes" + NL + "                                temp_";
  protected final String TEXT_65 = ".replace(\"\" + textEnclosure_";
  protected final String TEXT_66 = ", \"\" + textEnclosure_";
  protected final String TEXT_67 = " + textEnclosure_";
  protected final String TEXT_68 = ");" + NL + "                            }else{" + NL + "                                temp_";
  protected final String TEXT_69 = ".replace(\"\\\\\", \"\\\\\\\\\");" + NL + "                                temp_";
  protected final String TEXT_70 = ", \"\\\\\" + textEnclosure_";
  protected final String TEXT_71 = ");" + NL + "                            }" + NL + "                            out";
  protected final String TEXT_72 = ".append(textEnclosure_";
  protected final String TEXT_73 = ");" + NL + "                        \tout";
  protected final String TEXT_74 = ");" + NL + "                        }else{" + NL + "                            out";
  protected final String TEXT_75 = ");" + NL + "                        }" + NL + "                \t}";
  protected final String TEXT_76 = NL + "    \t\t\tout";
  protected final String TEXT_77 = ".write(OUT_DELIM_ROWSEP_";
