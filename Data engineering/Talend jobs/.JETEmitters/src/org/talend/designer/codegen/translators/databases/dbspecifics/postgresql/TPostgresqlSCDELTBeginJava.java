...
public class TPostgresqlSCDELTBeginJava {
  ...
  protected final String TEXT_7 = NL + "        java.lang.Class.forName(\"org.postgresql.Driver\");";
  ...
  protected final String TEXT_14 = NL + "        String dbUser_";
  ...
  protected final String TEXT_25 = ";" + NL + "" + NL + "        java.sql.Connection conn_";
  ...
  protected final String TEXT_29 = ");" + NL + "        String schema_";
  ...
  protected final String TEXT_40 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_41 = " = conn_";
  protected final String TEXT_42 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_43 = ".execute(\"";
  protected final String TEXT_44 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_45 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_46 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_47 = ")\");" + NL + "            stmtCreate_";
  protected final String TEXT_48 = ".close();";
  protected final String TEXT_49 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_50 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_51 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_52 = " = dbMetaData_";
  protected final String TEXT_53 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_54 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_55 = " = \"public\";" + NL + "            if(schema_";
  protected final String TEXT_56 = " == null || schema_";
  protected final String TEXT_57 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_68 = ".getString(\"TABLE_NAME\");" + NL + "                String schemaName_";
  protected final String TEXT_69 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_70 = ".equals(";
  protected final String TEXT_71 = ") " + NL + "                \t&& (schemaName_";
  protected final String TEXT_72 = ".equals(schema_";
  protected final String TEXT_73 = ") || ((schema_";
  protected final String TEXT_74 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_75 = ".equals(schemaName_";
  protected final String TEXT_76 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_77 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_78 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_83 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_87 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_88 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_89 = ")\");" + NL + "                stmtCreate_";
  protected final String TEXT_90 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_91 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_92 = ".executeUpdate(\"";
  protected final String TEXT_93 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_94 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_95 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_96 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_97 = NL + "        System.out.println(\"[";
  protected final String TEXT_98 = "] table action ";
  protected final String TEXT_99 = " done\\n\");";
  protected final String TEXT_100 = NL + "        String updateForType1_";
  protected final String TEXT_101 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_102 = " + \"\\\" d SET ";
  protected final String TEXT_103 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_104 = " + \"\\\" t WHERE ";
  protected final String TEXT_105 = " AND (";
  protected final String TEXT_106 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  ...
  protected final String TEXT_111 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_112 = " + \"\\ndone\");";
  protected final String TEXT_113 = NL + "        String updateForType2_";
  protected final String TEXT_114 = " + \"\\\" d SET \\\"";
  protected final String TEXT_115 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_116 = "\"))) + \"'";
  protected final String TEXT_117 = ", \\\"";
  protected final String TEXT_118 = "\\\" = 0";
  protected final String TEXT_119 = ") AND d.\\\"";
  protected final String TEXT_120 = "\\\" IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_121 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_122 = ".executeUpdate(updateForType2_";
  protected final String TEXT_123 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_124 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_125 = NL + "        String insertForType2_";
  protected final String TEXT_126 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_127 = " + \"\\\"(";
  protected final String TEXT_128 = "\\\"";
  protected final String TEXT_129 = "\\\", ";
  protected final String TEXT_130 = ") SELECT ";
  protected final String TEXT_131 = "NEXTVAL('\" + ";
  protected final String TEXT_132 = " + \"'), ";
  protected final String TEXT_133 = "t.";
  protected final String TEXT_134 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_135 = "\"))) + \"', NULL";
  protected final String TEXT_136 = ", 1";
  protected final String TEXT_137 = ", d.\\\"";
  protected final String TEXT_138 = "\\\" + 1";
  protected final String TEXT_139 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_140 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_141 = " + \"\\\" d WHERE ";
  protected final String TEXT_142 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_143 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_144 = ".executeUpdate(insertForType2_";
  protected final String TEXT_145 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_146 = "] type2 new active row sql\\n\" + insertForType2_";
  protected final String TEXT_147 = NL + "    String insert_";
  protected final String TEXT_148 = "\"";
  protected final String TEXT_149 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_150 = "\"))) + \"', NULL\"";
  protected final String TEXT_151 = NL + "    + \"";
  protected final String TEXT_152 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_153 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_154 = " + \"\\\" d ON ";
  protected final String TEXT_155 = " WHERE (";
  protected final String TEXT_156 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_157 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_158 = ".executeUpdate(insert_";
  protected final String TEXT_159 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_160 = "] new rows sql\\n\" + insert_";
