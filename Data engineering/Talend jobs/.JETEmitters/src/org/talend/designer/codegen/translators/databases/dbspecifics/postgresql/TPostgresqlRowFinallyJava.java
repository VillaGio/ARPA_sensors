...
public class TPostgresqlRowFinallyJava
{
  protected static String nl;
  public static synchronized TPostgresqlRowFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlRowFinallyJava result = new TPostgresqlRowFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_60 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_61 = "\") == null) {";
  protected final String TEXT_62 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_63 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_64 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_65 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_66 = ".close();" + NL + "            }";
  protected final String TEXT_67 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_68 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_69 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_70 = "\")) != null) {" + NL + "                stmtToClose_";
  protected final String TEXT_71 = NL + "    }";
  protected final String TEXT_72 = NL + "} finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_73 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_74 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_75 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_76 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_77 = NL + "                    ctn_";
  protected final String TEXT_78 = ".close();";
  protected final String TEXT_79 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_80 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_81 = " = \"failed to close the connection in ";
  protected final String TEXT_82 = " :\" + sqlEx_";
  protected final String TEXT_83 = ".getMessage();";
  protected final String TEXT_84 = NL + "                    System.err.println(errorMessage_";
  protected final String TEXT_85 = ");" + NL + "                }" + NL + "            }" + NL + "        }" + NL + "    }";
