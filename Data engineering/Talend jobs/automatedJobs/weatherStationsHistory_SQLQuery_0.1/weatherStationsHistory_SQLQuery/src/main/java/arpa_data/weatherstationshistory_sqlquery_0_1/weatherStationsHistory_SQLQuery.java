 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "SELECT tablename FROM pg_catalog.pg_tables where schemaname = 'public' and tablename like 'weather_data_%';";
...
".idsensore = stations_check_datastop.idsensore and stations_check_datastop.table_name = 'stations_weather') \ngroup by "
+"idsensore";
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("stations_weather");
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("stations_weather");
}
...
int count_tDBOutput_5=0;
	    String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5 + "\" SET \"datastop\" = ? WHERE \"idsensore\" = ?";
...
pstmt_tDBOutput_5.setTimestamp(1, new java.sql.Timestamp(update_datatastop.ultima_acquisizione.getTime()));
} else {
...
} else {pstmt_tDBOutput_5.setLong(2 + count_tDBOutput_5, update_datatastop.idsensore);
}
 ...
 */
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
		    ...
		    String dbquery_tDBInput_5 = "SELECT tablename FROM pg_catalog.pg_tables where schemaname = 'public' and tablename like 'weather_data_%' order by tab"
+"lename desc;";
 ...
 */
	NB_ITERATE_tDBInput_6++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate2", 1, "exec" + NB_ITERATE_tDBInput_6);
					//Thread.sleep(1000);
				}				
...
if(dbschema_tDBOutput_8 == null || dbschema_tDBOutput_8.trim().length() == 0) {
	tableName_tDBOutput_8 = ("stations_check_datastart");
} else {
	tableName_tDBOutput_8 = dbschema_tDBOutput_8 + "\".\"" + ("stations_check_datastart");
}

        int updateKeyCount_tDBOutput_8 = 1;
        if(updateKeyCount_tDBOutput_8 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_8 == 2 && true) {        
                throw new RuntimeException("For update, every Schema column can not be a key");
        }
...
int count_tDBOutput_8=0;
	    String update_tDBOutput_8 = "UPDATE \"" + tableName_tDBOutput_8 + "\" SET \"prima_acquisizione\" = ? WHERE \"idsensore\" = ?";
	    java.sql.PreparedStatement pstmt_tDBOutput_8 = conn_tDBOutput_8.prepareStatement(update_tDBOutput_8);
 ...
 */
	...
	currentComponent="tDBInput_6";
		...
		int tos_count_tDBInput_6 = 0;
		    ...
		    String dbquery_tDBInput_6 = "select idsensore, min(dataora) from " + ((String)globalMap.get("get_name_tables.tablename")) +
" where exists (\nselect * from stations_check_datastart where " + ((String)globalMap.get("get_name_tables.tablename")) + 
".idsensore = stations_check_datastart.idsensore and  stations_check_datastart.table_name='stations_weather' ) \ngroup b"
+"y idsensore";
            ...
            insert_datastart.idsensore = rs_tDBInput_6.getInt(1);
			...
			insert_datastart.min = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 2);
		                    }
...
pstmt_tDBOutput_8.setTimestamp(1, new java.sql.Timestamp(insert_datastart.min.getTime()));
} else {
pstmt_tDBOutput_8.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(insert_datastart.idsensore == null) {
pstmt_tDBOutput_8.setNull(2 + count_tDBOutput_8, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_8.setInt(2 + count_tDBOutput_8, insert_datastart.idsensore);
}
    		  ...
    		  batchSizeCounter_tDBOutput_8++;
                ...
                try {
				    	...
				    	rowsToCommitCount_tDBOutput_8 += countSum_tDBOutput_8;
				    		...
				    		updatedCount_tDBOutput_8 += countSum_tDBOutput_8;
 ...
 */
						...
						if(execStat){
							runStat.updateStatOnConnection("iterate2", 2, "exec" + NB_ITERATE_tDBInput_6);
						}				
...
if(dbschema_tDBOutput_9 == null || dbschema_tDBOutput_9.trim().length() == 0) {
	tableName_tDBOutput_9 = ("stations_weather");
} else {
	tableName_tDBOutput_9 = dbschema_tDBOutput_9 + "\".\"" + ("stations_weather");
}

        int updateKeyCount_tDBOutput_9 = 1;
        if(updateKeyCount_tDBOutput_9 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_9 == 2 && true) {        
                throw new RuntimeException("For update, every Schema column can not be a key");
        }
...
int count_tDBOutput_9=0;
	    String update_tDBOutput_9 = "UPDATE \"" + tableName_tDBOutput_9 + "\" SET \"datastart\" = ? WHERE \"idsensore\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_7";
		...
		int tos_count_tDBInput_7 = 0;
		    ...
		    String dbquery_tDBInput_7 = "select idsensore, min(prima_acquisizione) from stations_check_datastart\nwhere table_name = 'stations_weather'\ngroup b"
+"y idsensore;";
            ...
            update_datastart.idsensore = rs_tDBInput_7.getLong(1);
			...
			update_datastart.prima_acquisizione = routines.system.JDBCUtil.getDate(rs_tDBInput_7, 2);
		                    }
...
pstmt_tDBOutput_9.setTimestamp(1, new java.sql.Timestamp(update_datastart.prima_acquisizione.getTime()));
} else {
pstmt_tDBOutput_9.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(update_datastart.idsensore == null) {
pstmt_tDBOutput_9.setNull(2 + count_tDBOutput_9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_9.setLong(2 + count_tDBOutput_9, update_datastart.idsensore);
}
 ...
 */
	...
	String endpoint_tREST_1 = context.endpoinAPI_stations_weather;
...
!Var.datastop.equals(target.datastop) ;// ###############################
        // ###############################
        // # Output tables
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
issue_datastop_tmp.storico = json_data.storico ;
issue_datastop_tmp.datastop = Var.datastop ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
issue_datastart_tmp.datastart = Var.datastart ;
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("issues_datastop", new Integer(count_tFlowMeter_22), "null", "", "tFlowMeter_22");
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("issues_datastart", new Integer(count_tFlowMeter_23), "null", "", "tFlowMeter_23");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_target";
		...
		int tos_count_tAdvancedHash_target = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(json_data,target,check_datastop,check_datastart) outputs:(INSERT,UPDATE,issue_datastop,issue_datastart)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_check_datastop";
		...
		int tos_count_tAdvancedHash_check_datastop = 0;
			   		...
			   		// source node:tDBInput_10 - inputs:(after_tREST_1) outputs:(check_datastop,check_datastop) | target node:tAdvancedHash_check_datastop - inputs:(check_datastop) outputs:()
			   		// linked node: tMap_1 - inputs:(json_data,target,check_datastop,check_datastart) outputs:(INSERT,UPDATE,issue_datastop,issue_datastart)
 ...
 */
	...
	currentComponent="tDBInput_10";
		...
		int tos_count_tDBInput_10 = 0;
		    ...
		    String dbquery_tDBInput_10 = "select * from stations_check_datastop where table_name = 'stations_weather';";
            ...
            check_datastop.idsensore = rs_tDBInput_10.getInt(1);
			...
			check_datastop.ultima_acquisizione = routines.system.JDBCUtil.getDate(rs_tDBInput_10, 2);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_check_datastart";
		...
		int tos_count_tAdvancedHash_check_datastart = 0;
			   		...
			   		// source node:tDBInput_11 - inputs:(after_tREST_1) outputs:(check_datastart,check_datastart) | target node:tAdvancedHash_check_datastart - inputs:(check_datastart) outputs:()
			   		// linked node: tMap_1 - inputs:(json_data,target,check_datastop,check_datastart) outputs:(INSERT,UPDATE,issue_datastop,issue_datastart)
 ...
 */
	...
	currentComponent="tDBInput_11";
		...
		int tos_count_tDBInput_11 = 0;
		    ...
		    String dbquery_tDBInput_11 = "select * from stations_check_datastart where table_name = 'stations_weahter';";
            ...
            check_datastart.idsensore = rs_tDBInput_11.getInt(1);
			...
			check_datastart.prima_acquisizione = routines.system.JDBCUtil.getDate(rs_tDBInput_11, 2);
		                    }
...
/************************************************************************************************
 *     496815 characters generated by Talend Open Studio for Data Integration 
 *     on the August 22, 2022 at 11:16:10 AM CEST
 ************************************************************************************************/