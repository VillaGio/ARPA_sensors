...
public static class isses_datastopStruct implements routines.system.IPersistableRow<isses_datastopStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_sensorsStationsHistory_SQLQuery = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_sensorsStationsHistory_SQLQuery = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(isses_datastopStruct other) {
...
public static class issues_dstopStruct implements routines.system.IPersistableRow<issues_dstopStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_sensorsStationsHistory_SQLQuery = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_sensorsStationsHistory_SQLQuery = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(issues_dstopStruct other) {
...
public static class issues_dstartStruct implements routines.system.IPersistableRow<issues_dstartStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_sensorsStationsHistory_SQLQuery = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_sensorsStationsHistory_SQLQuery = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(issues_dstartStruct other) {
...
issues_dstopStruct issues_dstop = new issues_dstopStruct();
isses_datastopStruct isses_datastop = new isses_datastopStruct();
issues_dstartStruct issues_dstart = new issues_dstartStruct();
 ...
 */
	...
	currentComponent="tFlowMeter_30";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"isses_datastop");
					}
 ...
 */
	...
	currentComponent="tFilterRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"issues_dstop");
					}
 ...
 */
	...
	currentComponent="tFilterRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"issues_dstart");
					}
...
issues_dstopStruct issues_dstop_tmp = new issues_dstopStruct();
issues_dstartStruct issues_dstart_tmp = new issues_dstartStruct();
// ###############################
...
// # Output reject table : 'issues_dstop'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
issues_dstop_tmp.storico = sorgente.storico ;
issues_dstop_tmp.datastop = sorgente.datastop ;
issues_dstop = issues_dstop_tmp;
} // closing filter/reject

// # Output reject table : 'issues_dstart'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
issues_dstart_tmp.datastart = sorgente.datastart ;
issues_dstart = issues_dstart_tmp;
} // closing filter/reject
// ###############################
...
// Start of branch "issues_dstop"
if(issues_dstop != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((// code sample : use issues_dstop to define the condition.
// issues_dstop.columnName1.equals("foo") ||!(issues_dstop.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
issues_dstop.storico.equals("S") && issues_dstop.datastop.equals(TalendDate.parseDate("yyyy-MM-dd HH:mm:ss.SSS","9999-12-31 00:00:00.000"))
			), "advanced condition failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(isses_datastop == null){ 
                isses_datastop = new isses_datastopStruct();
              }
               isses_datastop.storico = issues_dstop.storico;
               isses_datastop.datastop = issues_dstop.datastop;    
 ...
 */
// Start of branch "isses_datastop"
if(isses_datastop != null) { 
...
} // End of branch "issues_dstop"




// Start of branch "issues_dstart"
if(issues_dstart != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
            ope_tFilterRow_2.matches((issues_dstart.datastart == null? false : issues_dstart.datastart.compareTo(TalendDate.parseDate("yyyy-MM-dd hh:mm:ss.SSS", "0001-01-01 00:00:00.000")) == 0)
    ...
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(issues_datastart == null){ 
               ...
               issues_datastart.datastart = issues_dstart.datastart;    
 ...
 */
    ...
    globalMap.put("tFilterRow_1_NB_LINE_REJECT", nb_line_reject_tFilterRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"issues_dstop");
			  	}
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("issues_datastop", new Integer(count_tFlowMeter_30), "null", "", "tFlowMeter_30");
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"isses_datastop");
			  	}
 ...
 */
    ...
    globalMap.put("tFilterRow_2_NB_LINE_REJECT", nb_line_reject_tFilterRow_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"issues_dstart");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_target";
		...
		int tos_count_tAdvancedHash_target = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(sorgente,target) outputs:(INSERTS,UPDATE,issues_dstop,issues_dstart)
 ...
 */
	...
	currentComponent="tDBInput_8";
		...
		int tos_count_tDBInput_8 = 0;
		    ...
		    String dbquery_tDBInput_8 = "select * from stations_check_datastart;";
 ...
 */
	...
	currentComponent="tDBInput_9";
		...
		int tos_count_tDBInput_9 = 0;
		    ...
		    String dbquery_tDBInput_9 = "select * from stations_check_datastop;";
...
query_tDBRow_1 = "insert into stations_check_datastop\nselect idsensore from stations_sens where storico='S' and datastop='9999-12-31 00:"
+"00:00.000'::timestamp;";
...
".idsensore = stations_check_datastop.idsensore) \ngroup by idsensore";
...
query_tDBRow_2 = "insert into stations_check_datastart\nselect idsensore from stations_sens where datastart='0001-01-01 00:00:00.000'::ti"
+"mestamp;";
...
".idsensore = stations_check_datastart.idsensore) \ngroup by idsensore";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("postgresWoneli_AdditionalParams")) {
...
/************************************************************************************************
 *     561790 characters generated by Talend Open Studio for Data Integration 
 *     on the 6 August 2022 at 17:03:13 CEST
 ************************************************************************************************/