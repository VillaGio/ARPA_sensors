...
package arpa_data.sensorspositionhistory_sqlquery_0_1;
...
/**
 * Job: sensorsPositionHistory_SQLQuery Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class sensorsPositionHistory_SQLQuery implements TalendJob {
...
public String getPostgres_woneli_Login(){
	...
	private final String jobName = "sensorsPositionHistory_SQLQuery";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				sensorsPositionHistory_SQLQuery.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sensorsPositionHistory_SQLQuery.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class manage_issuesStruct implements routines.system.IPersistableRow<manage_issuesStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_sensorsPositionHistory_SQLQuery = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery.length) {
				if(length < 1024 && commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery.length == 0) {
   					commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery = new byte[1024];
				} else {
   					commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery, 0, length);
			strReturn = new String(commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery, 0, length);
			strReturn = new String(commonByteArray_ARPA_DATA_sensorsPositionHistory_SQLQuery, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARPA_DATA_sensorsPositionHistory_SQLQuery) {
...
num_issuesStruct manage_issues = num_issues;
...
query_tDBRow_1 = "insert into stations_check_datastop\nselect idsensore from stations where storico='S' and datastop='9999-12-31 00:00:00"
+".000'::timestamp;";
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "SELECT tablename FROM pg_catalog.pg_tables where schemaname = 'woneli' and tablename like 'sens_data_%';";
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"idsensore\",\"ultima_acquisizione\") VALUES (?,?)";
...
} else {pstmt_tDBOutput_2.setInt(1, insert_datastop.idsensore);
}

                    if(insert_datastop.max != null) {
pstmt_tDBOutput_2.setTimestamp(2, new java.sql.Timestamp(insert_datastop.max.getTime()));
} else {
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("stations");
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("stations");
}
...
query_tDBRow_2 = "insert into stations_check_datastart\nselect idsensore from stations where datastart='9999-12-31 00:00:00.000'::timesta"
+"mp;";
 ...
 */
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
		    ...
		    String dbquery_tDBInput_5 = "SELECT tablename FROM pg_catalog.pg_tables where schemaname = 'woneli' and tablename like 'sens_data_%';";
...
int count_tDBOutput_5=0;
	    String insert_tDBOutput_5 = "INSERT INTO \"" + tableName_tDBOutput_5 + "\" (\"idsensore\",\"prima_acquisizione\") VALUES (?,?)";
...
} else {pstmt_tDBOutput_5.setInt(1, insert_datastart.idsensore);
}

                    if(insert_datastart.min != null) {
pstmt_tDBOutput_5.setTimestamp(2, new java.sql.Timestamp(insert_datastart.min.getTime()));
} else {
...
if(dbschema_tDBOutput_6 == null || dbschema_tDBOutput_6.trim().length() == 0) {
	tableName_tDBOutput_6 = ("stations");
} else {
	tableName_tDBOutput_6 = dbschema_tDBOutput_6 + "\".\"" + ("stations");
}
...
if(issues_dstart != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
            ope_tFilterRow_2.matches((issues_dstart.datastart == null? false : issues_dstart.datastart.compareTo(TalendDate.parseDate("yyyy-MM-dd hh:mm:ss.SSS", "9999-12-31 00:00:00.000")) == 0)
                           , "datastart.compareTo(TalendDate.parseDate(\"yyyy-MM-dd hh:mm:ss.SSS\", \"9999-12-31 00:00:00.000\")) == 0 failed");
...
targetStruct target = new targetStruct();
	...
	currentComponent="tAdvancedHash_target";
		...
		int tos_count_tAdvancedHash_target = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(sorgente,target) outputs:(INSERTS,NOT_INSERT,issues_dstop,issues_dstart)
 ...
 */
    ...
    public static void main(String[] args){
        final sensorsPositionHistory_SQLQuery sensorsPositionHistory_SQLQueryClass = new sensorsPositionHistory_SQLQuery();

        int exitCode = sensorsPositionHistory_SQLQueryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sensorsPositionHistory_SQLQuery.class.getClassLoader().getResourceAsStream("arpa_data/sensorspositionhistory_sqlquery_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sensorsPositionHistory_SQLQuery.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sensorsPositionHistory_SQLQuery");
        }
...
/************************************************************************************************
 *     617383 characters generated by Talend Open Studio for Data Integration 
 *     on the 30 July 2022 at 12:14:13 CEST
 ************************************************************************************************/