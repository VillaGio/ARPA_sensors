...
java.net.URL url_tHttpRequest_2 = new java.net.URL(context.endpoinAPI_sensors_currentY);

java.net.HttpURLConnection urlConn_tHttpRequest_2 = null;

if ("local".equals(System.getProperty("http.proxySet"))) {
    java.net.Proxy proxyToUse = org.talend.proxy.TalendProxySelector.getInstance().getProxyForUriString(context.endpoinAPI_sensors_currentY);
...
} else {pstmt_tDBOutput_3.setLong(1, INSERT.idsensore);
}

                    if(INSERT.dataora != null) {
pstmt_tDBOutput_3.setTimestamp(2, new java.sql.Timestamp(INSERT.dataora.getTime()));
} else {
...
} else {pstmt_tDBOutput_3.setFloat(3, INSERT.valore);
}

                    if(INSERT.stato == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, INSERT.stato);
}

                    if(INSERT.idoperatore == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(5, INSERT.idoperatore);
}
...
} else {pstmt_tDBOutput_4.setLong(1, DELETED.idsensore);
}

					
                    if(DELETED.dataora != null) {
pstmt_tDBOutput_4.setTimestamp(2, new java.sql.Timestamp(DELETED.dataora.getTime()));
} else {
...
/************************************************************************************************
 *     437745 characters generated by Talend Open Studio for Data Integration 
 *     on the August 22, 2022 at 10:59:17 AM CEST
 ************************************************************************************************/