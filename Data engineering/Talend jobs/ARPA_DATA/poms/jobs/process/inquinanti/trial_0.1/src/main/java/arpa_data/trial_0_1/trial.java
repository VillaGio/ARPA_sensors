 ...
 * @status
 */
public class trial implements TalendJob {
	...
	private final String jobName = "trial";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(trial.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(context.main_path + context.sensors_path_input);
	...
	public static void main(String[] args) {
		final trial trialClass = new trial();

		int exitCode = trialClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = trial.class.getClassLoader()
					.getResourceAsStream("arpa_data/trial_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = trial.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : trial");
		}
...
/************************************************************************************************
 * 52363 characters generated by Talend Open Studio for Data Integration on the
 * November 6, 2022 at 8:52:35 AM CET
 ************************************************************************************************/