...
package arpa_data.splitcsv_0_1;
...
/**
 * Job: splitCsv Purpose: <br>
 * Description: Splits input csv files into smaller-size csvs.
Handles rejected rows by inserting them into a postgres db table.
Writes job logs into postgres db table. <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class splitCsv implements TalendJob {
...
public Boolean getTruncate(){
	...
	private final String jobName = "splitCsv";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(splitCsv.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class insertRejectStruct implements routines.system.IPersistableRow<insertRejectStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_splitCsv = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_splitCsv = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARPA_DATA_splitCsv.length) {
				if(length < 1024 && commonByteArray_ARPA_DATA_splitCsv.length == 0) {
   					commonByteArray_ARPA_DATA_splitCsv = new byte[1024];
				} else {
   					commonByteArray_ARPA_DATA_splitCsv = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARPA_DATA_splitCsv, 0, length);
			strReturn = new String(commonByteArray_ARPA_DATA_splitCsv, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARPA_DATA_splitCsv, 0, length);
			strReturn = new String(commonByteArray_ARPA_DATA_splitCsv, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARPA_DATA_splitCsv) {

        	try {

        		int length = 0;
		
					this.tabella = readString(dis);
...
public static class split_csvStruct implements routines.system.IPersistableRow<split_csvStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_splitCsv = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_splitCsv = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(split_csvStruct other) {
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		split_csvStruct split_csv = new split_csvStruct();
...
insertRejectStruct insertReject = new insertRejectStruct();
  ...
  String directory_tFileList_1 = context.path_original;
  final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add(context.csv_to_split);  
 ...
 */
	NB_ITERATE_tFileInputDelimited_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("rejected", 3, 0);
					}           			
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("insertReject", 3, 0);
					}           			
				
					if(execStat){				
	       				runStat.updateStatOnConnection("split_csv", 3, 0);
					}           			
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"split_csv");
					}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.path_splitted+ ((String)globalMap.get("tFileList_1_CURRENT_FILE")))).getAbsolutePath().replace("\\","/");
    ...
    if(filetFileOutputDelimited_1.exists()){
            ...
            int splitEvery_tFileOutputDelimited_1 = 15000000;
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("rejected");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("rejected");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"tabella\",\"idsensore\",\"data\",\"valore\",\"stato\",\"idoperatore\",\"errormessage\") VALUES (?,?,?,?,?,?,?)";
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								split_csv.IdSensore = ParserUtils.parseTo_Long(temp);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"IdSensore", "split_csv", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									split_csv.IdSensore = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							split_csv.Data = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								split_csv.Valore = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Valore", "split_csv", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									split_csv.Valore = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							split_csv.Stato = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								split_csv.idOperatore = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"idOperatore", "split_csv", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									split_csv.idOperatore = null;
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
			        					whetherReject_tFileInputDelimited_1 = true;
			                    				...
			                    				rejected = new rejectedStruct();
				                				
    				rejected.IdSensore = split_csv.IdSensore;
				
    				rejected.Data = split_csv.Data;
				
    				rejected.Valore = split_csv.Valore;
				
    				rejected.Stato = split_csv.Stato;
				
    				rejected.idOperatore = split_csv.idOperatore;
				
			
				                				rejected.errorMessage = e.getMessage() + " - Line: " + tos_count_tFileInputDelimited_1;
			                					split_csv = null;
...
if(split_csv != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(split_csv.IdSensore != null) {
                        sb_tFileOutputDelimited_1.append(
                            split_csv.IdSensore
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(split_csv.Data != null) {
                        sb_tFileOutputDelimited_1.append(
                            split_csv.Data
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(split_csv.Valore != null) {
                        sb_tFileOutputDelimited_1.append(
                            split_csv.Valore
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(split_csv.Stato != null) {
                        sb_tFileOutputDelimited_1.append(
                            split_csv.Stato
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(split_csv.idOperatore != null) {
                        sb_tFileOutputDelimited_1.append(
                            split_csv.idOperatore
                        );
                            }
...
insertReject_tmp.tabella = context.category +((String)globalMap.get("tFileList_1_CURRENT_FILE")).substring(0,((String)globalMap.get("tFileList_1_CURRENT_FILE")).length() -4) ;
insertReject_tmp.IdSensore = rejected.IdSensore;
insertReject_tmp.Data = rejected.Data;
insertReject_tmp.Valore = rejected.Valore;
insertReject_tmp.Stato = rejected.Stato;
insertReject_tmp.idOperatore = rejected.idOperatore;
insertReject_tmp.errorMessage = rejected.errorMessage;
...
if(insertReject != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(insertReject.tabella == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, insertReject.tabella);
}

                    if(insertReject.IdSensore == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(2, insertReject.IdSensore);
}

                    if(insertReject.Data == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, insertReject.Data);
}

                    if(insertReject.Valore == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.FLOAT);
} else {pstmt_tDBOutput_1.setFloat(4, insertReject.Valore);
}

                    if(insertReject.Stato == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, insertReject.Stato);
}

                    if(insertReject.idOperatore == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(6, insertReject.idOperatore);
}

                    if(insertReject.errorMessage == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, insertReject.errorMessage);
}
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"split_csv");
			  	}
...
end_Hash.put("tFileList_1", System.currentTimeMillis());
   			...
   			if (((Integer)globalMap.get("count_reject")) > 0) {
...
Integer count_reject = ((Integer)globalMap.get("count_reject")) +((Integer)globalMap.get("tDBOutput_1_NB_LINE"));

globalMap.put("count_reject", count_reject);
 ...
 */
	...
	logs.table_name = "rejected";        	            	
	logs.operation = "Rejected";        	            	
	logs.number_of_rows = ((Integer)globalMap.get("count_reject"));        	            	
	logs.duration_in_seconds = Math.toIntExact(TalendDate.getCurrentDate().getTime() - startTime)/1000;
...
pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(logs.current_date.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setString(2, logs.table_name);
}

                    if(logs.operation == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, logs.operation);
}

                    if(logs.number_of_rows == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(4, logs.number_of_rows);
}

                    if(logs.duration_in_seconds == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(5, logs.duration_in_seconds);
}
 ...
 */
    ...
    public static void main(String[] args){
        final splitCsv splitCsvClass = new splitCsv();

        int exitCode = splitCsvClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = splitCsv.class.getClassLoader().getResourceAsStream("arpa_data/splitcsv_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = splitCsv.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : splitCsv");
        }
...
/************************************************************************************************
 *     162996 characters generated by Talend Open Studio for Data Integration 
