...
package arpa_data.bulkinsertw_0_1;
...
/**
 * Job: bulkInsertW Purpose: <br>
 * Description: Performs ingestion of weather data from 1989 to 2021 stored in csv files. Those are splitted into smaller-size csv to enhance performance by calling splitCsvBulk job.
Handles the issue of daylight saving time change.
Writes job logs in postgres db table by calling finalizeBulk job and cleans csv files generated in the splitting process. <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class bulkInsertW implements TalendJob {
...
public Boolean getTruncate(){
	...
	private final String jobName = "bulkInsertW";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(bulkInsertW.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tDBOutputBulkExec_1_tPOB_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
							tDBOutputBulkExec_1_tPBE_error(exception, errorComponent, globalMap);
						
						}
					
			public void tDBOutputBulkExec_1_tPBE_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class DateChangedStruct implements routines.system.IPersistableRow<DateChangedStruct> {
    final static byte[] commonByteArrayLock_ARPA_DATA_bulkInsertW = new byte[0];
    static byte[] commonByteArray_ARPA_DATA_bulkInsertW = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARPA_DATA_bulkInsertW.length) {
				if(length < 1024 && commonByteArray_ARPA_DATA_bulkInsertW.length == 0) {
   					commonByteArray_ARPA_DATA_bulkInsertW = new byte[1024];
				} else {
   					commonByteArray_ARPA_DATA_bulkInsertW = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARPA_DATA_bulkInsertW, 0, length);
			strReturn = new String(commonByteArray_ARPA_DATA_bulkInsertW, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARPA_DATA_bulkInsertW, 0, length);
			strReturn = new String(commonByteArray_ARPA_DATA_bulkInsertW, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARPA_DATA_bulkInsertW) {
...
DateChangedStruct DateChanged = new DateChangedStruct();
  ...
  String directory_tFileList_2 = context.main_path+context.weather_path_input_splitted;
 ...
 */
	...
	/**
	 * [tDBOutputBulkExec_1_tPOB begin ] start
	 */
		...
		ok_Hash.put("tDBOutputBulkExec_1_tPOB", false);
		start_Hash.put("tDBOutputBulkExec_1_tPOB", System.currentTimeMillis());
		
	
		currentVirtualComponent = "tDBOutputBulkExec_1";
	
	currentComponent="tDBOutputBulkExec_1_tPOB";
		...
		int tos_count_tDBOutputBulkExec_1_tPOB = 0;
		

		int nb_line_tDBOutputBulkExec_1_tPOB = 0;
		
		final Character OUT_DELIM_tDBOutputBulkExec_1_tPOB = /** Start field tDBOutputBulkExec_1_tPOB:FIELDSEPARATOR */";"/** End field tDBOutputBulkExec_1_tPOB:FIELDSEPARATOR */.charAt(0); 
		
		final String OUT_DELIM_ROWSEP_tDBOutputBulkExec_1_tPOB = /** Start field tDBOutputBulkExec_1_tPOB:ROWSEPARATOR */"\n"/** End field tDBOutputBulkExec_1_tPOB:ROWSEPARATOR */;
		
		java.io.File file_tDBOutputBulkExec_1_tPOB=new java.io.File(/** Start field tDBOutputBulkExec_1_tPOB:FILENAME */context.main_path+context.weather_path_output + "mod_int_" + ((String)globalMap.get("tFileList_4_CURRENT_FILE"))/** End field tDBOutputBulkExec_1_tPOB:FILENAME */);
		final java.io.BufferedWriter outtDBOutputBulkExec_1_tPOB = new java.io.BufferedWriter(new java.io.OutputStreamWriter(
        		new java.io.FileOutputStream(file_tDBOutputBulkExec_1_tPOB, false),"ISO-8859-15"));
       	resourceMap.put("outtDBOutputBulkExec_1_tPOB", outtDBOutputBulkExec_1_tPOB); 
        	char escapeChar_tDBOutputBulkExec_1_tPOB = "\\".charAt(0);

       		char textEnclosure_tDBOutputBulkExec_1_tPOB = "\"".charAt(0);

	        int escape_mode_tDBOutputBulkExec_1_tPOB = 0;  // 0: double quotes; 1: backslash
    	    if(escapeChar_tDBOutputBulkExec_1_tPOB=='\\'){
        	    escape_mode_tDBOutputBulkExec_1_tPOB = 1;
	        }else if(escapeChar_tDBOutputBulkExec_1_tPOB == textEnclosure_tDBOutputBulkExec_1_tPOB){
    	        escape_mode_tDBOutputBulkExec_1_tPOB = 0;
        	}else {
            	throw new RuntimeException("The escape mode only support the '\\' or double text enclosure.");
	        }
			if(file_tDBOutputBulkExec_1_tPOB.length()==0){
    				outtDBOutputBulkExec_1_tPOB.write("idsensore");
    			outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_tDBOutputBulkExec_1_tPOB.toString());
    				outtDBOutputBulkExec_1_tPOB.write("dataora");
    			outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_tDBOutputBulkExec_1_tPOB.toString());
    				outtDBOutputBulkExec_1_tPOB.write("valore");
    			outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_tDBOutputBulkExec_1_tPOB.toString());
    				outtDBOutputBulkExec_1_tPOB.write("stato");
    			outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_tDBOutputBulkExec_1_tPOB.toString());
    				outtDBOutputBulkExec_1_tPOB.write("idoperatore");
    			
	    		outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_ROWSEP_tDBOutputBulkExec_1_tPOB);
	    	}
...
/**
 * [tDBOutputBulkExec_1_tPOB begin ] stop
 */
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.idOperatore == null) ? 0 : this.idOperatore.hashCode());
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.main_path+context.weather_path_input_splitted + ((String)globalMap.get("tFileList_2_CURRENT_FILE"));
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.main_path+context.weather_path_input_splitted + ((String)globalMap.get("tFileList_2_CURRENT_FILE")), "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"IdSensore", "weather_data", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							weather_data.Data = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Valore", "weather_data", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							weather_data.Stato = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"idOperatore", "weather_data", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
uniques = null;			
finder_tUniqRow_1.IdSensore = weather_data.IdSensore;
if(weather_data.Data == null){
	finder_tUniqRow_1.Data = null;
}else{
	finder_tUniqRow_1.Data = weather_data.Data.toLowerCase();
}
finder_tUniqRow_1.Valore = weather_data.Valore;
if(weather_data.Stato == null){
	finder_tUniqRow_1.Stato = null;
}else{
	finder_tUniqRow_1.Stato = weather_data.Stato.toLowerCase();
}
finder_tUniqRow_1.idOperatore = weather_data.idOperatore;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.IdSensore = weather_data.IdSensore;
if(weather_data.Data == null){
	new_tUniqRow_1.Data = null;
}else{
	new_tUniqRow_1.Data = weather_data.Data.toLowerCase();
}
new_tUniqRow_1.Valore = weather_data.Valore;
if(weather_data.Stato == null){
	new_tUniqRow_1.Stato = null;
}else{
	new_tUniqRow_1.Stato = weather_data.Stato.toLowerCase();
}
new_tUniqRow_1.idOperatore = weather_data.idOperatore;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(uniques == null){ 
	
	uniques = new uniquesStruct();
}uniques.IdSensore = weather_data.IdSensore;			uniques.Data = weather_data.Data;			uniques.Valore = weather_data.Valore;			uniques.Stato = weather_data.Stato;			uniques.idOperatore = weather_data.idOperatore;					
...
Var.Data = data.Data.equals("26/05/1968 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1968-05-26 01:59:00"):
data.Data.equals("01/06/1969 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1969-06-01 01:59:00"):
data.Data.equals("31/05/1970 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1970-05-31 01:59:00"):
data.Data.equals("23/05/1971 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1971-05-23 01:59:00"):
data.Data.equals("28/05/1972 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1971-05-28 01:59:00"):
data.Data.equals("03/06/1973 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1973-06-03 01:59:00"):
data.Data.equals("26/05/1974 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1974-05-26 01:59:00"):
data.Data.equals("01/06/1975 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1975-06-01 01:59:00"):
data.Data.equals("30/05/1976 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1976-05-30 01:59:00"):
data.Data.equals("22/05/1977 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1977-05-22 01:59:00"):
data.Data.equals("28/05/1978 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1978-05-28 01:59:00"):
data.Data.equals("27/05/1979 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1979-05-27 01:59:00"):
data.Data.equals("06/04/1980 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1980-04-06 01:59:00"):
data.Data.equals("29/03/1981 02:00:00")?TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", "1981-03-29 01:59:00"):
data.Data.equals(((String)globalMap.get("change_time_date")))?
TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.parseDate("dd/MM/yyyy HH:mm:ss",StringHandling.CHANGE(((String)globalMap.get("change_time_date")),"02:00:00"," 01:59:00")))):
TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.parseDate("dd/MM/yyyy HH:mm:ss",data.Data))) ;// ###############################
        // ###############################
        // # Output tables
...
if(DateChanged != null) { 
	...
	/**
	 * [tDBOutputBulkExec_1_tPOB main ] start
	 */
	...
	currentComponent="tDBOutputBulkExec_1_tPOB";
               	...
               	String[] row_tDBOutputBulkExec_1_tPOB=new String[]{"", "", "", "", ""};   				
				       	if(DateChanged.idsensore != null){
    	                    	row_tDBOutputBulkExec_1_tPOB[0] = String.valueOf(DateChanged.idsensore);
  						}   				
				       	if(DateChanged.dataora != null){
    	                    	row_tDBOutputBulkExec_1_tPOB[1] = FormatterUtils.format_Date(DateChanged.dataora, "yyyy-MM-dd HH:mm:ss");
  						}   				
				       	if(DateChanged.valore != null){
    	                    	row_tDBOutputBulkExec_1_tPOB[2] = String.valueOf(DateChanged.valore);
  						}   				
				       	if(DateChanged.stato != null){
                            	row_tDBOutputBulkExec_1_tPOB[3] = DateChanged.stato;
  						}   				
				       	if(DateChanged.idoperatore != null){
    	                    	row_tDBOutputBulkExec_1_tPOB[4] = String.valueOf(DateChanged.idoperatore);
  						}
					for (int i_tDBOutputBulkExec_1_tPOB = 0; i_tDBOutputBulkExec_1_tPOB < row_tDBOutputBulkExec_1_tPOB.length; i_tDBOutputBulkExec_1_tPOB++) {
						if(i_tDBOutputBulkExec_1_tPOB != 0) {
                        	outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_tDBOutputBulkExec_1_tPOB.toString());
                        }
                		String temp_tDBOutputBulkExec_1_tPOB = row_tDBOutputBulkExec_1_tPOB[i_tDBOutputBulkExec_1_tPOB];
                        if(!"".equals(temp_tDBOutputBulkExec_1_tPOB)) {
                            if (escape_mode_tDBOutputBulkExec_1_tPOB == 0 ) { // double quotes
                                temp_tDBOutputBulkExec_1_tPOB = temp_tDBOutputBulkExec_1_tPOB.replace("" + textEnclosure_tDBOutputBulkExec_1_tPOB, "" + textEnclosure_tDBOutputBulkExec_1_tPOB + textEnclosure_tDBOutputBulkExec_1_tPOB);
                            }else{
                                temp_tDBOutputBulkExec_1_tPOB = temp_tDBOutputBulkExec_1_tPOB.replace("\\", "\\\\");
                                temp_tDBOutputBulkExec_1_tPOB = temp_tDBOutputBulkExec_1_tPOB.replace("" + textEnclosure_tDBOutputBulkExec_1_tPOB, "\\" + textEnclosure_tDBOutputBulkExec_1_tPOB);
                            }
                            outtDBOutputBulkExec_1_tPOB.append(textEnclosure_tDBOutputBulkExec_1_tPOB);
                        	outtDBOutputBulkExec_1_tPOB.write(temp_tDBOutputBulkExec_1_tPOB);
                        	outtDBOutputBulkExec_1_tPOB.append(textEnclosure_tDBOutputBulkExec_1_tPOB);
                        }else{
                            outtDBOutputBulkExec_1_tPOB.write(temp_tDBOutputBulkExec_1_tPOB);
                        }
    			...
    			outtDBOutputBulkExec_1_tPOB.write(OUT_DELIM_ROWSEP_tDBOutputBulkExec_1_tPOB);
    			nb_line_tDBOutputBulkExec_1_tPOB++;

 


	tos_count_tDBOutputBulkExec_1_tPOB++;

/**
 * [tDBOutputBulkExec_1_tPOB main ] stop
 */
	
	/**
	 * [tDBOutputBulkExec_1_tPOB process_data_begin ] start
	 */
...
/**
 * [tDBOutputBulkExec_1_tPOB process_data_begin ] stop
 */
	
	/**
	 * [tDBOutputBulkExec_1_tPOB process_data_end ] start
	 */
...
/**
 * [tDBOutputBulkExec_1_tPOB process_data_end ] stop
 */
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.main_path+context.weather_path_input_splitted + ((String)globalMap.get("tFileList_2_CURRENT_FILE"))) instanceof java.io.InputStream)){
 ...
 */
	...
	/**
	 * [tDBOutputBulkExec_1_tPOB end ] start
	 */
	...
	outtDBOutputBulkExec_1_tPOB.close();
	resourceMap.put("finish_tDBOutputBulkExec_1_tPOB", true); 
	globalMap.put("tDBOutputBulkExec_1_tPOB_NB_LINE",nb_line_tDBOutputBulkExec_1_tPOB);
...
ok_Hash.put("tDBOutputBulkExec_1_tPOB", true);
end_Hash.put("tDBOutputBulkExec_1_tPOB", System.currentTimeMillis());




/**
 * [tDBOutputBulkExec_1_tPOB end ] stop
 */

	
	/**
	 * [tDBOutputBulkExec_1_tPBE begin ] start
	 */
		...
		ok_Hash.put("tDBOutputBulkExec_1_tPBE", false);
		start_Hash.put("tDBOutputBulkExec_1_tPBE", System.currentTimeMillis());
		
	
		currentVirtualComponent = "tDBOutputBulkExec_1";
	
	currentComponent="tDBOutputBulkExec_1_tPBE";

	
		int tos_count_tDBOutputBulkExec_1_tPBE = 0;
		

int deletedCount_tDBOutputBulkExec_1_tPBE=0;
String tableName_tDBOutputBulkExec_1_tPBE = null;
String dbschema_tDBOutputBulkExec_1_tPBE = null;
	dbschema_tDBOutputBulkExec_1_tPBE = context.postgresWoneli_Schema;
	
if(dbschema_tDBOutputBulkExec_1_tPBE == null || dbschema_tDBOutputBulkExec_1_tPBE.trim().length() == 0) {
	tableName_tDBOutputBulkExec_1_tPBE = "weather_data_" +((String)globalMap.get("tFileList_4_CURRENT_FILE")).substring(0,((String)globalMap.get("tFileList_4_CURRENT_FILE")).length() -4);
} else {
	tableName_tDBOutputBulkExec_1_tPBE = dbschema_tDBOutputBulkExec_1_tPBE + "\".\"" + "weather_data_" +((String)globalMap.get("tFileList_4_CURRENT_FILE")).substring(0,((String)globalMap.get("tFileList_4_CURRENT_FILE")).length() -4);
}
String bulkSQL_tDBOutputBulkExec_1_tPBE = "COPY \"" + tableName_tDBOutputBulkExec_1_tPBE 
+ "\" (\"idsensore\",\"dataora\",\"valore\",\"stato\",\"idoperatore\") FROM " + 
		 "STDIN" 
		+ " WITH ";
    Character field_separator_tDBOutputBulkExec_1_tPBE = (";").charAt(0);
    bulkSQL_tDBOutputBulkExec_1_tPBE += " " + "DELIMITER AS '" + field_separator_tDBOutputBulkExec_1_tPBE + "' ";
	
		bulkSQL_tDBOutputBulkExec_1_tPBE += "NULL AS '" + "" + "' ";
	
        Character text_enclosure_tDBOutputBulkExec_1_tPBE = ("\"").charAt(0);
		        bulkSQL_tDBOutputBulkExec_1_tPBE += "CSV HEADER QUOTE AS " + ("'".equals(text_enclosure_tDBOutputBulkExec_1_tPBE.toString())?"E":"") + "'" +("'".equals(text_enclosure_tDBOutputBulkExec_1_tPBE)?"\\":"") + text_enclosure_tDBOutputBulkExec_1_tPBE + "' ";
		
				bulkSQL_tDBOutputBulkExec_1_tPBE += "ESCAPE AS '" + "\\" + "' ";
		        
        bulkSQL_tDBOutputBulkExec_1_tPBE += ""; 
java.sql.Connection conn_tDBOutputBulkExec_1_tPBE = null;
	

		
			String driverClass_tDBOutputBulkExec_1_tPBE = "org.postgresql.Driver";
			
	            String url_tDBOutputBulkExec_1_tPBE = "jdbc:postgresql://" + context.postgresWoneli_Server + ":" + context.postgresWoneli_Port + "/" + context.postgresWoneli_Database + "?" + context.postgresWoneli_AdditionalParams;
	            
		
		
		String dbUser_tDBOutputBulkExec_1_tPBE = context.postgresWoneli_Login;
		java.lang.Class.forName(driverClass_tDBOutputBulkExec_1_tPBE).newInstance();
		
		
		
	final String decryptedPassword_tDBOutputBulkExec_1_tPBE = context.postgresWoneli_Password; 
	   	
		String dbPwd_tDBOutputBulkExec_1_tPBE = decryptedPassword_tDBOutputBulkExec_1_tPBE;
	
			conn_tDBOutputBulkExec_1_tPBE = java.sql.DriverManager.getConnection(url_tDBOutputBulkExec_1_tPBE, dbUser_tDBOutputBulkExec_1_tPBE, dbPwd_tDBOutputBulkExec_1_tPBE);
			

		
   	java.sql.CallableStatement cs_tDBOutputBulkExec_1_tPBE =conn_tDBOutputBulkExec_1_tPBE.prepareCall("set standard_conforming_strings=on");
   	cs_tDBOutputBulkExec_1_tPBE.execute();
   	cs_tDBOutputBulkExec_1_tPBE.close();
    
	
		try (java.io.FileReader fileReader = new java.io.FileReader(context.main_path+context.weather_path_output + "mod_int_" + ((String)globalMap.get("tFileList_4_CURRENT_FILE")))){
			org.postgresql.copy.CopyManager copyManager = new org.postgresql.copy.CopyManager((org.postgresql.core.BaseConnection) conn_tDBOutputBulkExec_1_tPBE);
			copyManager.copyIn(bulkSQL_tDBOutputBulkExec_1_tPBE, fileReader );
		}
	
	
	
	
			conn_tDBOutputBulkExec_1_tPBE.close();
...
/**
 * [tDBOutputBulkExec_1_tPBE begin ] stop
 */
	
	/**
	 * [tDBOutputBulkExec_1_tPBE main ] start
	 */
	...
	tos_count_tDBOutputBulkExec_1_tPBE++;

/**
 * [tDBOutputBulkExec_1_tPBE main ] stop
 */
	
	/**
	 * [tDBOutputBulkExec_1_tPBE process_data_begin ] start
	 */
...
/**
 * [tDBOutputBulkExec_1_tPBE process_data_begin ] stop
 */
	
	/**
	 * [tDBOutputBulkExec_1_tPBE process_data_end ] start
	 */
...
/**
 * [tDBOutputBulkExec_1_tPBE process_data_end ] stop
 */
	
	/**
	 * [tDBOutputBulkExec_1_tPBE end ] start
	 */
...
ok_Hash.put("tDBOutputBulkExec_1_tPBE", true);
end_Hash.put("tDBOutputBulkExec_1_tPBE", System.currentTimeMillis());
...
/**
 * [tDBOutputBulkExec_1_tPBE end ] stop
 */
 ...
 */
	...
	/**
	 * [tDBOutputBulkExec_1_tPOB finally ] start
	 */
	...
	if(resourceMap.get("finish_tDBOutputBulkExec_1_tPOB") == null){
		if(resourceMap.get("outtDBOutputBulkExec_1_tPOB") != null){
			((java.io.BufferedWriter)resourceMap.get("outtDBOutputBulkExec_1_tPOB")).close();
		}
	}
...
/**
 * [tDBOutputBulkExec_1_tPOB finally ] stop
 */

	
	/**
	 * [tDBOutputBulkExec_1_tPBE finally ] start
	 */
...
/**
 * [tDBOutputBulkExec_1_tPBE finally ] stop
 */
...
Integer count = ((Integer)globalMap.get("count")) + ((Integer)globalMap.get("tUniqRow_1_NB_UNIQUES"));
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = context.main_path+context.weather_path_output;
		if(obj_tRunJob_4!=null) {
			if (obj_tRunJob_4.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_4.add("--context_param path_bulk=" + ((java.util.Date) obj_tRunJob_4).getTime());
			} else {
				paraList_tRunJob_4.add("--context_param path_bulk=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
			}
		} else {
			paraList_tRunJob_4.add("--context_param path_bulk=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("path_bulk", obj_tRunJob_4);
	
	
		arpa_data.combinesplittedcsv_0_1.combineSplittedCsv childJob_tRunJob_4 = new arpa_data.combinesplittedcsv_0_1.combineSplittedCsv();
	    // pass DataSources
	...
	Object obj_tRunJob_2 = null;
		...
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_2.add("--context_param duration=" + ((java.util.Date) obj_tRunJob_2).getTime());
			} else {
				paraList_tRunJob_2.add("--context_param duration=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
			}
		} else {
			paraList_tRunJob_2.add("--context_param duration=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("duration", obj_tRunJob_2);
	
		obj_tRunJob_2 = ((Integer)globalMap.get("count"));
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_2.add("--context_param num_rows=" + ((java.util.Date) obj_tRunJob_2).getTime());
			} else {
				paraList_tRunJob_2.add("--context_param num_rows=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
			}
		} else {
			paraList_tRunJob_2.add("--context_param num_rows=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		...
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_2.add("--context_param operation=" + ((java.util.Date) obj_tRunJob_2).getTime());
			} else {
				paraList_tRunJob_2.add("--context_param operation=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
			}
		} else {
			paraList_tRunJob_2.add("--context_param operation=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("operation", obj_tRunJob_2);
	
		obj_tRunJob_2 = "weather_data_" +((String)globalMap.get("tFileList_4_CURRENT_FILE")).substring(0,((String)globalMap.get("tFileList_4_CURRENT_FILE")).length() -4);
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_2.add("--context_param table_name=" + ((java.util.Date) obj_tRunJob_2).getTime());
			} else {
				paraList_tRunJob_2.add("--context_param table_name=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
			}
		} else {
			paraList_tRunJob_2.add("--context_param table_name=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("table_name", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.main_path+context.weather_path_input_splitted;
		if(obj_tRunJob_2!=null) {
			if (obj_tRunJob_2.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_2.add("--context_param path_splitted=" + ((java.util.Date) obj_tRunJob_2).getTime());
			} else {
				paraList_tRunJob_2.add("--context_param path_splitted=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
			}
		} else {
			paraList_tRunJob_2.add("--context_param path_splitted=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
...
query_tDBRow_1 = "TRUNCATE TABLE " +
"weather_data_" +((String)globalMap.get("tFileList_4_CURRENT_FILE")).substring(0,((String)globalMap.get("tFileList_4_CURRENT_FILE")).length() -4) +
...
public void tFileList_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_4 = context.main_path+context.weather_path_input;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_4 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_4.add(context.regex_file_to_read);  
  ...
  final boolean case_sensitive_tFileList_4 = true;
	...
	java.io.File file_tFileList_4 = new java.io.File(directory_tFileList_4);
        ...
        Comparator<java.io.File> fileNameASC_tFileList_4 = new Comparator<java.io.File>() {
      ...
      java.util.Collections.sort(list_tFileList_4, fileNameASC_tFileList_4);
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = ((String)globalMap.get("tFileList_4_CURRENT_FILE"));
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param csv_to_split=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				paraList_tRunJob_1.add("--context_param csv_to_split=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
			}
		} else {
			paraList_tRunJob_1.add("--context_param csv_to_split=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("csv_to_split", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.main_path+context.weather_path_input;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param path_original=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				paraList_tRunJob_1.add("--context_param path_original=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
			}
		} else {
			paraList_tRunJob_1.add("--context_param path_original=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("path_original", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.main_path+context.weather_path_input_splitted;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param path_splitted=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				paraList_tRunJob_1.add("--context_param path_splitted=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
			}
		} else {
			paraList_tRunJob_1.add("--context_param path_splitted=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
 ...
 */
    ...
    public static void main(String[] args){
        final bulkInsertW bulkInsertWClass = new bulkInsertW();

        int exitCode = bulkInsertWClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = bulkInsertW.class.getClassLoader().getResourceAsStream("arpa_data/bulkinsertw_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = bulkInsertW.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : bulkInsertW");
        }
...
/************************************************************************************************
 *     205158 characters generated by Talend Open Studio for Data Integration 
 *     on the November 8, 2022 at 9:05:18 AM CET
 ************************************************************************************************/