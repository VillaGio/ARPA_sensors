...
##pm10
plot(lomb, main="PM10 monitoring stations in Lombardy", col="darkolivegreen1")
...
#Biossido di azoto
plot(lomb, main="Nitrogen dioxide monitoring stations in Lombardy", col="darkolivegreen1")
...
#Ossido di azoto
plot(lomb, main="Nitric oxide monitoring stations in Lombardy", col="darkolivegreen1")
...
plot(lomb, main="Carbon monoxide monitoring stations in Lombardy", col="darkolivegreen1")
...
#Ozono
plot(lomb, main="Ozone monitoring stations in Lombardya", col="darkolivegreen1")
points(stazioni$lng[stazioni$NomeTipoSensore=="Ozono"],stazioni$lat[stazioni$NomeTipoSensore=="Ozono"], col='blue',pch=19)
leg.txt<-"Ozono"
legend(9.2,44.92,leg.txt,bty="n",pch=19,col="blue")

#Particelle sospese PM2.5
plot(lomb, main="PM2.5 monitoring stations in Lombardy", col="darkolivegreen1")
...
plot(lomb, main="Particulate matter monitoring stations in Lombardy", col="darkolivegreen1")
...
#Altre sostanze.1
plot(lomb, main="Ammonia, Arsenic, Benzene and Benzopyrene monitoring stations in Lombardy", col="darkolivegreen1")
...
#Altre sostanze.2
plot(lomb, main="Elementar Carbon, Cadmium, Nitrogen monoxide, Nickel and Lead monitoring stations in Lombardy", col="darkolivegreen1")
points(stazioni$lng[stazioni$NomeTipoSensore=="BlackCarbon" | stazioni$NomeTipoSensore=="Cadmio" | 
                      stazioni$NomeTipoSensore=="Monossido di Azoto" | stazioni$NomeTipoSensore=="Nikel" | 
                      stazioni$NomeTipoSensore=="Piombo"],stazioni$lat[stazioni$NomeTipoSensore=="BlackCarbon" | 
                      stazioni$NomeTipoSensore=="Cadmio" | stazioni$NomeTipoSensore=="Monossido di Azoto" | 
                        stazioni$NomeTipoSensore=="Nikel" | stazioni$NomeTipoSensore=="Piombo"], col=c("blue","red","pink","yellow","forestgreen"),pch=19,cex=1.3)
